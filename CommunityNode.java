...
public class CommunityNode {
     ...
     */
    public CommunityNode(String communityName, double population, double percentWhite, double percentBlack, double percentAsian, double percentHispanic, double pM2_5, double floodChance, double povertyRate, double medianIncome) {
        this.name = null;
        this.next = null;
        this.info = null;
    }
    ...
    public CommunityNode(String communityName, CommunityData data) {
    ...
    public double getMedianIncome() {
        ...
        throw new UnsupportedOperationException("Unimplemented method 'getMedianIncome'");
    }

    public double getFloodChance() {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'getFloodChance'");
    }

    public double getPM2_5() {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'getPM2_5'");
    }

    public int getPovertyRate() {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'getPovertyRate'");
    }

    public double getPercentHispanic() {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'getPercentHispanic'");
    }

    public double getPercentWhite() {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'getPercentWhite'");
    }

    public double getPercentBlack() {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'getPercentBlack'");
    }

    public double getPercentAsian() {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'getPercentAsian'");
    }
